...
import UserAccountDropdown from "./navbar"; // NEW
        ...
        <div className="max-w-screen-2xl mx-auto px-6 py-3 flex items-center justify-between">
          ...
          <div className="flex items-center space-x-6">
            <Dropdown
              label="Men's"
              items={[
                { label: "Chains", href: "/men/chains" },
                { label: "Watches", href: "/men" },
                // { label: "Bracelet", href: "/mens-bracelet" },
            ...
            <Dropdown
              label="Women's"
              items={[
                { label: "Chains", href: "/women/chains" },
                { label: "Watches", href: "/women" },
            ...
            <Link to="/coming-soon" className="text-sm font-medium hover:text-[#9c7a56]">
              BLOGS
            </Link>
            <Dropdown
              label="More at ASD"
          ...
          <div className="flex items-center space-x-6">
            ...
            {user ? (
              ...
              <button onClick={() => setLoginOpen(true)} className="hover:text-[#9c7a56]" title="Login">
            ...
            {/* cart */}
            <div className="relative">
              <button onClick={() => setDrawerOpen(true)} className="hover:text-[#9c7a56]" title="Open Cart">
